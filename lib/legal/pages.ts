// Ported from build-legal.mjs's `pages` array (originally used to
// pre-render legal/*.html at the flat /legal/<slug>.html paths). Content is
// kept verbatim; only the internal cross-links were rewritten from
// "<slug>.html" to the new "/legal/<slug>/" App Router routes. `body` is
// raw HTML (not JSX) — rendered via dangerouslySetInnerHTML on the detail
// page, exactly as it was written directly into the page template before.

export const BRAND = "Buckeye Broadband Authorized Agent";
export const PHONE_DISPLAY = "(419) 828-0022";
export const PHONE_HREF = "+14198280022";
export const EMAIL = "care@buckeyeagent.com";
export const SITE = "https://www.buckeyeagent.com";
export const UPDATED = "July 7, 2026";
...
<div class="lz-note">You can unsubscribe from marketing emails using the link in any message, and you can opt out of calls and texts as described in our <a href="/legal/tcpa/">TCPA Policy</a>.</div>
...
<p>We may advertise through search engines, social media, email and phone. Email and phone outreach follow our <a href="/legal/privacy/">Privacy</a> and <a href="/legal/tcpa/">TCPA</a> policies, including consent requirements and simple ways to opt out. We do not send unsolicited bulk email (spam) or use deceptive subject lines.</p>
...
<p>Billing is handled directly by the service provider through their secure systems. ${BRAND} does not process or store your payment card details on this website — see our <a href="/legal/pci-dss/">PCI DSS</a> page. Your first bill and monthly charges, including any applicable taxes and fees, are governed by the provider's terms.</p>
...
<ul>
  ...
  <li>We limit the personal data we collect to what's needed to help you order (see <a href="/legal/privacy/">Privacy</a>).</li>
